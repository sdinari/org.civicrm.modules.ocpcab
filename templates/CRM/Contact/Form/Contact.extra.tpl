...
<script type="text/javascript">
 ...
 //alert("Hello! I am an alert box!!");
   ...
   university = cj('#customData9 > table > tbody > tr.custom_field-row.custom_49_-1-row').html();
   ...
   cj('#customData9 > table > tbody > tr.custom_field-row.custom_49_-1-row').hide();
   // shortbio Institution moving
  institution = cj('#customData9 > table > tbody > tr.custom_field-row.custom_50_-1-row').html();
  ...
  cj('#customData9 > table > tbody > tr.custom_field-row.custom_50_-1-row').hide();
   //Add cv print  button
   ...
   //123*****
   /////
   //copy nationality from shortbio to top page  (update  page)
                    
   nationality = cj('#customData9 > table > tbody > tr.custom_field-row.custom_44_67-row').html();
   nationality = nationality.replace(/<td class="label"\>([\w\<\s="\-\>.*\/]*)(<\/td>)([\W]*)(<td class="html-adjust">)([\W\w]*)/gm,'<td class="html-adjust" colspan="3"">$1<br>$5');
   //alert(nationality); 
   cj('#contactDetails > div.crm-section.contact_basic_information-section > table > tbody > tr:nth-child(1)').before('<tr>'+nationality+'</tr>');
   cj('#customData9 > table > tbody > tr.custom_field-row.custom_44_67-row').hide();

   //copy type from shortbio to top page 
             
   type = cj('#customData9 > table > tbody > tr.custom_field-row.custom_48_67-row').html();
   type = type.replace('crm-form-select','crm-select2'); //crm-form-select  --> crm-select2 huge
   ...
   cj('#contactDetails > div.crm-section.contact_basic_information-section > table > tbody > tr:nth-child(1)').before('<tr>'+type+'</tr>');
   cj('#customData9 > table > tbody > tr.custom_field-row.custom_48_67-row').hide();
   ...
   university = cj('#customData9 > table > tbody > tr.custom_field-row.custom_49_67-row').html();
   university = university.replace(/<td class="label"\>([\w\<\s="\-\>.*\/]*)(<\/td>)([\W]*)(<td class="html-adjust">)([\W\w]*)/gm,'<td class="html-adjust">$1<br>$5');
   cj('#contactDetails > div.crm-section.contact_basic_information-section > table > tbody > tr:nth-child(5)').after('<tr>'+university+'</tr>');
   cj('#customData9 > table > tbody > tr.custom_field-row.custom_49_67-row').hide();   

   // shortbio Institution moving
  institution = cj('#customData9 > table > tbody > tr.custom_field-row.custom_50_67-row').html();
  institution = institution.replace(/<td class="label"\>([\w\<\s="\-\>.*\/]*)(<\/td>)([\W]*)(<td class="html-adjust">)([\W\w]*)/gm,'<td class="html-adjust">$1<br>$5');
  cj('#contactDetails > div.crm-section.contact_basic_information-section > table > tbody > tr:nth-child(6)').after('<tr>'+institution+'</tr>');
  
  cj('#customData9 > table > tbody > tr.custom_field-row.custom_50_67-row').hide();   
